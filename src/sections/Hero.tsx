...
export const Hero = () => {
  return (
    <section className="h-[492px] md:h-[800px] flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]" style={{
      ...
      {/* First Ring */}
      <div className="absolute h-[344px] w-[344px] md:h-[580px] md:w-[580px] border opacity-20 rounded-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
      ...
      {/* Second Ring */}
      <div className="absolute h-[444px] w-[444px] md:h-[780px] md:w-[780px] border border-white/20 border-dashed rounded-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"></div>

      {/* Third Ring */}
      <div className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] border border-white opacity-20 rounded-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
        <div className="absolute h-2 w-2 bg-white top-1/2 left-0 -translate-x-1/2 -translate-y-1/2 rounded-full"></div>
